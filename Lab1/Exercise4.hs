...
-- two lists are permutations of each other if they contain the same elements, possibly in a different order
...
-- property 4: known permutation test
-- if we shuffle a list, it should be a permutation of that original list
